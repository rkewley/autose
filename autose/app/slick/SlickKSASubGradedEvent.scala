...
trait KSASubGradedEventComponent  {
	...
	object KSASubGradedEvent extends Table[MdlKSASubGradedEvent]("KSASubGradedEvent") with Crud[MdlKSASubGradedEvent, Long]  {
      ...
      def vidKSASubGradedEvent = column[Long]("idKSASubGradedEvent", O.PrimaryKey, O.AutoInc)
	  ...
	  def insert(vKSASubGradedEvent: MdlKSASubGradedEvent): Long = {
	    AppDB.database.withSession { implicit session: Session =>
	      KSASubGradedEvent.forInsert returning KSASubGradedEvent.vidKSASubGradedEvent insert MdlKSASubGradedEvent(None, vKSASubGradedEvent.vKSA, vKSASubGradedEvent.vSubGradedEvent)
